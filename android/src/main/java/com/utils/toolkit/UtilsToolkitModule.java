...
public class UtilsToolkitModule extends ReactContextBaseJavaModule {

    private final ReactApplicationContext reactContext;

    public UtilsToolkitModule(ReactApplicationContext reactContext) {
        super(reactContext);
